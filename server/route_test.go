...
func getRouter() (*gin.Engine, sqlmock.Sqlmock) {
	...
	router, err := server.GetRouter(dialector, nil, "", "", "", "", false, nil, nil, true, 3600, "", "user@test.com", "Test User", "Confirming your registration", "test.com", "Your password has been changed")
	if err != nil {
		panic(err)
	}
	return router, mock
